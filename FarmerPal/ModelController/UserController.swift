...
//
    ...
    // Create
    func createUser(username: String, password: String, id: String, firstName: String, lastName: String, phoneNum: String, email: String, city: String, userType: String, context: NSManagedObjectContext) {
        
//        user = User(username: username, password: password, id: id, firstName: firstName, lastName: lastName, phoneNum: phoneNum, email: email, city: city, userType: userType, context: context)
//        CoreDataStack.shared.save(context: context)
//        put(user: user)
    }
//    
